;(function() {
  ...
  function l(key) {
    if(!(key in localizations['en-GB'])) {
      throw new TypeError('Key `' + key + '` not in en-GB localizations');
    }
    return localizations['en-GB'][key].call(localizations['en-GB'], arguments[1]);
  }
